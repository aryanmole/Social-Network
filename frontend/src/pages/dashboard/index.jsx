      ...
      <DashboardLayout>
        ...
        <div className={styles.wrapper}>
          <div className={styles.createPostContainer}>
              <img className={styles.userProfile} style={{width:'10%'}} src={`${BASE_URL}/uploads/${authState.user?.userId?.profilePicture}`}/>
                ...
                {postState.message && (
                  <p style={{color: postState.isError ? "red" : "green", margin: "6px 0"}}>
                    {postState.message}
                  </p>
                )}
                                ...
                                <div className={styles.singleCard_profileContainer}>
                                    ...
                                    <div>
                                      <div onClick={async ()=>{ 
                                          ...
                                          style={{justifyContent:'space-between',height:'1.4rem',display:'flex', paddingRight:'10px'}} className={styles.topRow}>
                                          <p style={{fontWeight:'bold'}}>{post.userId.name}</p>
                                       
     
                                          { post.userId._id === authState.user?.userId?._id && <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...

        {
          ...
          className={styles.commentContainer}>
            ...
            className={styles.allCommentsContainer}>
                  ...
                  {postState.comments.length === 0 && <h2 style={{display:'flex',alignItems:'center',justifyContent:'center'}}>No Comments</h2>}
